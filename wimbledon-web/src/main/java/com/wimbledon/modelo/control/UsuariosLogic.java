...
public class UsuariosLogic implements IUsuariosLogic {
    ...
    */
    @Autowired
    IDirectortorneoLogic logicDirectortorneo2;
    ...
    public void saveUsuarios(Usuarios entity) throws Exception {
        ...
        try {
            ...
            if ((entity.getLogin() != null) &&
                    (Utilities.checkWordAndCheckWithlength(entity.getLogin(), 20) == false)) {
            ...
            if (getUsuarios(entity.getUsuaId()) != null) {
    ...
    public List<UsuariosDTO> getDataUsuarios() throws Exception {
        try {
            ...
            for (Usuarios usuariosTmp : usuarios) {
                ...
                usuariosDTO2.setUsuaId(usuariosTmp.getUsuaId());
                usuariosDTO2.setLogin((usuariosTmp.getLogin() != null)
                    ? usuariosTmp.getLogin() : null);
                usuariosDTO2.setPassword((usuariosTmp.getPassword() != null)
                    ? usuariosTmp.getPassword() : null);
                usuariosDTO2.setArbiId_Arbitro((usuariosTmp.getArbitro()
                                                           .getArbiId() != null)
                    ? usuariosTmp.getArbitro().getArbiId() : null);
                usuariosDTO2.setDitoId_Directortorneo((usuariosTmp.getDirectortorneo()
                                                                  .getDitoId() != null)
                    ? usuariosTmp.getDirectortorneo().getDitoId() : null);
    ...
    public Usuarios getUsuarios(Integer usuaId) throws Exception {
        ...
        try {
            entity = usuariosDAO.findById(usuaId);
        } catch (Exception e) {
