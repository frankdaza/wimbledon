...
public class ArbitroView implements Serializable {
    ...
    public void rowEventListener(RowEditEvent e) {
        try {
            ...
            txtDocuId.setValue(arbitroDTO.getDocuId());
    ...
    public String action_clear() {
        ...
        if (txtArbiId != null) {
            txtArbiId.setValue(null);
            txtArbiId.setDisabled(false);
        }
    ...
    public void listener_txtId() {
        try {
            Integer arbiId = FacesUtils.checkInteger(txtArbiId);
            entity = (arbiId != null)
                ? businessDelegatorView.getArbitro(arbiId) : null;
        } catch (Exception e) {
            entity = null;
        }
        ...
        if (entity == null) {
            ...
            txtNumeroIdentificacion.setDisabled(false);
            txtArbiId.setValue(entity.getArbiId());
    ...
    public String action_edit(ActionEvent evt) {
        selectedArbitro = (ArbitroDTO) (evt.getComponent().getAttributes()
                                           .get("selectedArbitro"));
        txtDocuId.setValue(selectedArbitro.getDocuId());
        txtDocuId.setDisabled(false);
